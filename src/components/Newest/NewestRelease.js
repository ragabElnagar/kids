...
import { newestReleaseMoviesData as movies } from "@/data/movie";
import MovieCardTwo from "@/components/Card/MovieCardTwo";
      ...
      <div className="pt-80">
        <div className="hl-container d-flex align-items-center justify-content-between">
          <h3 className="d-inline-flex align-item-center section-header style-two mb-0 lh-1">
            <span className="section-title mt-2">Newest releases</span>
            <svg
          ...
          <div className="slider-btn-wrapper d-flex align-item-center justify-content-center gap-3">
            <button className="slider-btn slider-btn--sm newest-release-prev-slide">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="23"
                height="18"
            ...
            <button className="slider-btn next-slide slider-btn--sm next-slide newest-release-next-slide">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="23"
                height="17"
        ...
        {movies && movies.length > 0 && (
          <Swiper
            {...swiperOptions}
            className="swiper newest-release-slider movie-card-two-container pt-60 pb-80"
          >
            {movies.map((movie, index) => (
              <SwiperSlide key={index} className="transform-unset">
