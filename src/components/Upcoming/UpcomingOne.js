...
import { upcomingMoviesData as movies } from "@/data/movie";
import Link from "next/link";

export default function UpcomingOne({ isLoop = false }) {
  const swiperOption = {
    speed: 9000,
    spaceBetween: 10,
    loop: true,
    ...
    <div class="related-movie pt-80">
      <div class="container mb-45">
        <div class="d-flex align-items-center justify-content-between">
          <h3 class="section-title mt-1 mt-lg-2 mb-0 lh-1">Upcoming Movies</h3>
          <Link
            href="pagination-one"
