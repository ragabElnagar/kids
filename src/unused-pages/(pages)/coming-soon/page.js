...
import comingSoonBackground from "@/../public/assets/images/background/coming-soon2.png";
...
export default function ComingSoonPage() {
  return (
    <div
      ...
      style={{
        backgroundImage: "url('assets/images/background/coming-soon.webp')",
      }}
    >
      <div className="container">
        <div className="row">
          <div className="col-lg-6 align-self-center">
            <div className="coming-soon-inner text-lg-start text-center">
              <div className="clock-wrap">
                <div className="countdown"></div>
              </div>
              <h6 className="sub-title">
                We&apos;re diligently working on the new version
              </h6>
              <h2 className="title">coming soon</h2>
              <div className="subscribe-from">
                <input type="text" placeholder="Enter Email" />
                <button className="btn btn-base text-white">Subscribe</button>
              </div>
